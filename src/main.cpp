...
int main() {
  ...
  int size[] = { 500, 800, 1000,1500, 2000,4000, 5000,6000,8000,10000,25000,30000,40000,50000,60000,120000,150000, 200000,250000,300000, 400000, 500000, 600000, 700000, 800000, 900000, 1000000, 0 };
